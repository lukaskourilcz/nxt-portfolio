        ...
        {CONTENT.experience.map((exp) => (
          ...
          >
            <div className="font-mono text-xs leading-relaxed">
              <p className="text-zinc-400 light:text-zinc-600">{exp.period}</p>
              <p className="mt-1 text-zinc-600 light:text-zinc-500">
                {exp.location}
              </p>
            </div>
            ...
            <div>
              <div className="flex items-center gap-3">
                ...
                <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-md border border-transparent bg-white p-0.5 hover:animate-[logo-pulse_0.45s_ease-in-out] light:border-zinc-200">
                  <Image
                    src={exp.logo}
              ...
              <ul className="mt-4 space-y-1.5">
                {exp.responsibilities.map((res, j) => (
                  <li
                    key={j}
                    className="flex gap-2 text-sm leading-snug text-zinc-400 light:text-zinc-600"
                  >
                    <span className="mt-0.5 select-none font-mono text-zinc-600 light:text-zinc-400">
                      ›
                    </span>
                    <span>{res}</span>
                  </li>
